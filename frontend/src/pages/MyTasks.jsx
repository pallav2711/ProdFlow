  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-24">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4 mb-6 sm:mb-8">
        <div className="bg-white p-4 sm:p-5 rounded-xl border border-gray-200 shadow-sm desktop-hover">
        ...
        <div className="bg-white p-4 sm:p-5 rounded-xl border border-gray-200 shadow-sm desktop-hover">
          ...
          <p className="text-xl sm:text-2xl font-bold text-gray-700">{stats.todo}</p>
        </div>
        <div className="bg-white p-4 sm:p-5 rounded-xl border border-gray-200 shadow-sm desktop-hover">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
        {/* Filters */}
        <div className="p-4 sm:p-5 bg-gray-50 border-b border-gray-200 rounded-t-xl">
          <div className="flex flex-col sm:flex-row sm:items-center gap-3">
            <span className="text-sm font-medium text-gray-700">Filter:</span>
            <div className="flex flex-wrap gap-2 overflow-x-auto sm:overflow-visible -mx-1 px-1">
              <button
                onClick={() => setFilterStatus('all')}
                className={`px-3 py-2 rounded-lg text-xs sm:text-sm font-medium transition-colors touch-target whitespace-nowrap ${
                  filterStatus === 'all'
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-2 mb-2">
                        <h3 className="font-bold text-base sm:text-lg text-gray-900 truncate">{task.title}</h3>
                        {task.workType && (
                      ...
                      <div className="flex flex-wrap items-center gap-3 text-xs text-gray-500">
                        ...
                        <span className="flex items-center gap-1 flex-shrink-0">
                          ...
                          <span className="truncate">Sprint: {task.sprint?.name || 'No sprint'}</span>
                        </span>
                      </div>
                      {task.reviewNotes && (
                    ...
                    <div className="lg:ml-4 w-full lg:w-auto lg:min-w-0 lg:max-w-xs">
                      {user.role === 'Developer' ? (
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-gray-500">Submit when done</p>
                        </div>
                      ) : (
                        <div className="space-y-2">
                          <label className="block text-xs font-medium text-gray-700">Update Status</label>
