  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary via-secondary to-white px-4 py-8 relative overflow-hidden">
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        {/* Register Card */}
        <div className="bg-white/80 backdrop-blur-xl p-4 sm:p-5 rounded-2xl shadow-2xl border border-gray-200/50 mobile-card">
          <div className="mb-4">
            <h2 className="text-xl sm:text-2xl font-bold text-accent mb-1">Create account</h2>
            <p className="text-sm text-gray-600">Start planning smarter with AI</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-3 sm:py-2 text-sm border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all bg-white/50 touch-target"
              />
            </div>
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-700 mb-1">Select Your Role</label>
              <select
                name="role"
                value={formData.role}
                onChange={handleChange}
                className="w-full px-3 py-3 sm:py-2 text-sm border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all bg-white/50 cursor-pointer touch-target"
              >
                {roles.map((role) => (
