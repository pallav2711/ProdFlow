  ...
  return (
    <div className="h-screen flex items-center justify-center bg-gradient-to-br from-primary via-secondary to-white px-4 relative overflow-hidden">
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        {/* Register Card */}
        <div className="bg-white/80 backdrop-blur-xl p-5 rounded-2xl shadow-2xl border border-gray-200/50">
          <div className="mb-4">
            <h2 className="text-2xl font-bold text-accent mb-1">Create account</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 text-sm border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all bg-white/50"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                value={formData.role}
                onChange={handleChange}
                className="w-full px-3 py-2 text-sm border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all bg-white/50 cursor-pointer"
              >
                {roles.map((role) => (
